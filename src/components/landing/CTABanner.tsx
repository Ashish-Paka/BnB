...
export default function CTABanner() {
  return (
    <motion.a
      ...
      className="block w-full cursor-pointer hover:scale-[1.02] active:scale-[0.98] mb-5 md:mb-7 p-8 sm:p-10 md:p-14 rounded-[3rem] bg-gradient-to-br from-brand-olive via-emerald-500 to-brand-olive bg-[length:200%_200%] animate-gradient text-white shadow-[0_20px_50px_-12px_rgba(132,204,22,0.4)] relative overflow-hidden group text-center border border-white/20 transition-all"
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        <h3 className="font-serif text-[1.65rem] sm:text-4xl md:text-5xl lg:text-6xl font-black mb-8 md:mb-10 leading-tight drop-shadow-md">
          Visit Bones and Bru Online
        </h3>
        <div className="flex flex-wrap items-center justify-center gap-4 w-full">
          <div className="inline-flex items-center justify-center gap-3 bg-white text-brand-olive px-6 py-3 md:px-8 md:py-4 rounded-full font-bold text-base md:text-xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
